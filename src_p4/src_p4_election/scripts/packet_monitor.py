...
class packetReceicer(threading.Thread):
    ...
    def gen_per_packet_log(self, pkt):
        ...
        if enable_log == True:
            ...
            log_file.write("Incoming packet: old_type: {}, old_stage: {}, old_value: {}, old_channel_id: {}, old_message_id: {}\n".format(
                pkt_cpu.msg_type, pkt_cpu.stage, pkt_cpu.value, pkt_cpu.channel_id, pkt_cpu.message_id
            ))
            log_file.write("Output packet: type: {}, stage: {}, value: {}, channel_id: {}, message_id: {}\n".format(pkt_sync.msg_type, pkt_sync.stage, new_value, pkt_sync.channel_id, pkt_sync.message_id))
